...
print(f"The total value of the loans is: ${total_loan_cost}")
...
# YOUR CODE HERE!
#####note annual_discount_rate = 20% or .20
...
# YOUR CODE HERE!
if Present_Value >= total_loan_cost:
...
for price in loans:
    price = price.get("loan_price")
    if price <= 500:
        inexpenensive_loans.append(price)               
        


# @TODO: Print the `inexpensive_loans` list
# YOUR CODE HERE!
print(inexpenensive_loans)
...
csvpath = Path("inexpenensive_loans.csv")


with open(csvpath, 'w', newline='') as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(header)
    for row in inexpenensive_loans:
        print(row)   
